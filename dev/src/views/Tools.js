...
export default class Tools extends EventDispatcher {
	...
	_initUI() {
		...
		this.headerEl.addEventListener("click", (evt) =>
			this._handleHeaderClick(evt)
		);
		...
		$.query(".help.icon", el).addEventListener("click", () =>
			app.sidebar.goto(this._toolId)
		);
