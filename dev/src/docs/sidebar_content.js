...
home.kids = [
...

	{
		...
		id: "favorites",
		desc:
			"The list above will display any patterns that you create or favorite." +
...

	{
		...
		id: "community",
		desc:
			"Welcome to Community Patterns, a searchable database of patterns submitted by users like you." +
...

	{
		...
		id: "help",
		desc:
			"Help for the RegExr application. See the <b>RegEx Reference</b> for help with Regular Expressions.",
		kids: [
			{
				label: "About",
				desc:
					"RegExr v<%= build_version %> (<%= build_date %>)." +
			...
			},
			{
				...
				desc:
					"RegExr provides real-time visual results, syntax highlighting, tooltips, and undo/redo ({{getCtrlKey()}}-Z / Y) so it's easy and fun to explore Regular Expressions." +
				...
				kids: [
					{
						...
						desc:
							"This is where you enter a regular expression to test. The results in the <b>Text</b> and <b>Tools</b> panel will update as you type." +
					...
					},
					{
						label: "Text panel",
						desc:
							"This is where you enter text to test your expression against. Drag & drop a text file to load its contents." +
					...
					},
					{
						label: "Tests panel",
						desc:
							"This allows you to create a suite of tests that you can use to validate your <b>Expression</b> in real time." +
					...
					},
					{
						label: "Tools panel",
						desc:
							"Click the <b>Tools</b> title bar below the <b>Text</b> panel to show or hide the <b>Tools</b> panel." +
						...
						kids: [
							{
								...
								id: "replace",
								desc:
									"The <b>Replace</b> tool replaces matches with a specified string or pattern." +
							...
							},
							{
								...
								id: "list",
								desc:
									"The <b>List</b> tool lists all found matches." +
							...
							},
							{
								...
								id: "details",
								desc:
									"The <b>Details</b> tool displays the full text of a match and its capture groups." +
							...
							},
							{
								...
								id: "explain",
								desc:
									"The <b>Explain</b> tool displays a detailed breakdown of the <b>Expression</b>." +
					...
					},
					{
						label: "Menu",
						desc:
							"The <b>Menu</b> (this panel) includes <b>Help</b>, a full <b>RegEx Reference</b>, a <b>Cheatsheet</b>, and <b>Pattern Settings</b> features." +
			...
			},
			{
				...
				id: "signin",
				desc:
					"Before you sign in, RegExr creates a temporary account which relies on a browser cookie. This means you can't access your patterns on other computers, and that you could lose your patterns if your cookies are deleted or expire." +
				...
				kids: [
					{
						label: "JavaScript",
						desc:
							"Your browser's JavaScript engine is used to execute RegEx in an asynchronous worker using <code>RegExp.exec()</code>." +
					...
					},
					{
						label: "PCRE (PHP)",
						desc:
							"PHP {{getPHPVersion()}} and PCRE {{getPCREVersion()}} are used to execute your pattern on our server.",
					},
				],
			},
			{
				...
				desc:
					"In addition to the built in <b>Save</b> mechanism which creates a shareable link, RegExr also supports the ability to pre-populate a pattern via the query string." +
